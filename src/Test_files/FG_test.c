...
int main() {
    ...
    //starting tests
    if (system("./fauxgrep-mt -n 2 mad Tgrep1.txt") == 0) {
    ...
    if (system("./fauxgrep-mt -n 2 kebab Tgrep1.txt Tgrep2.txt Tgrep3.txt") == 0) {
